...
public class P15_04_AllTaskSchedulingOrders {
    /**
     * Time and space complexity of the algorithm will be O(V! * E) where ‘V’ is the total number of tasks and ‘E’ is
     * the total prerequisites. We need the ‘E’ part because in each recursive call, at max, we remove (and add back)
     * all the edges. (If we don’t have any prerequisites, all combinations of the tasks can represent a topological
     * ordering. As we know, that there can be N! combinations for ‘N’ numbers)
     *
     * @param tasks
     * @param prerequisites
     */
    ...
    public static void main(String[] args) {
        P15_04_AllTaskSchedulingOrders.printOrders(3, new int[][] { new int[] { 0, 1 }, new int[] { 1, 2 } });
        System.out.println();

        P15_04_AllTaskSchedulingOrders.printOrders(4,
                new int[][] { new int[] { 3, 2 }, new int[] { 3, 0 }, new int[] { 2, 0 }, new int[] { 2, 1 } });
        System.out.println();

        P15_04_AllTaskSchedulingOrders.printOrders(6, new int[][] { new int[] { 2, 5 }, new int[] { 0, 5 }, new int[] { 0, 4 },

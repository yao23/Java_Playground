...
public class P15_07_MinimumHeightTrees {
    /**
     * Time complexity
     * In step ‘d’, each node can become a source only once and each edge will be accessed and removed once. Therefore,
     * the time complexity of the above algorithm will be O(V+E), where ‘V’ is the total nodes and ‘E’ is the total
     * number of the edges.
     *
     * Space complexity
    ...
    public static void main(String[] args) {
        List<Integer> result = P15_07_MinimumHeightTrees.findTrees(5,
                new int[][] { new int[] { 0, 1 }, new int[] { 1, 2 }, new int[] { 1, 3 }, new int[] { 2, 4 } });
        System.out.println("Roots of MHTs: " + result);

        result = P15_07_MinimumHeightTrees.findTrees(4,

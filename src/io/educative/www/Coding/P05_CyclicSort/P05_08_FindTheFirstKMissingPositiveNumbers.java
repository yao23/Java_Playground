...
class P05_08_FindTheFirstKMissingPositiveNumbers {
    /**
     * Time complexity
    ...
    public static void main(String[] args) {
        List<Integer> missingNumbers = P05_08_FindTheFirstKMissingPositiveNumbers.findNumbers(new int[] { 3, -1, 4, 5, 5 }, 3);
        System.out.println("Missing numbers: " + missingNumbers);

        missingNumbers = P05_08_FindTheFirstKMissingPositiveNumbers.findNumbers(new int[] { 2, 3, 4 }, 3);
        System.out.println("Missing numbers: " + missingNumbers);

        missingNumbers = P05_08_FindTheFirstKMissingPositiveNumbers.findNumbers(new int[] { -2, -3, 4 }, 2);
        System.out.println("Missing numbers: " + missingNumbers);
    }
}
...
public class P12_03_KClosestPointsToTheOrigin {
    /**
     * Time complexity
     * The time complexity of this algorithm is (K+(N-K)*logK) as we iterating all points and pushing them into the heap.
     *
     * Space complexity
    ...
    public static void main(String[] args) {
        ...
        List<Point> result = P12_03_KClosestPointsToTheOrigin.findClosestPoints(points, 2);

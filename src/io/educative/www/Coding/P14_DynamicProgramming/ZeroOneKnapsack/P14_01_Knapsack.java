...
public class P14_01_Knapsack {
     ...
     *
     * Time and Space complexity
     * The above solution has the time and space complexity of O(N*C)O(N∗C), where ‘N’ represents total items and ‘C’
    ...
    public static void main(String[] args) {
        P14_01_Knapsack ks = new P14_01_Knapsack();

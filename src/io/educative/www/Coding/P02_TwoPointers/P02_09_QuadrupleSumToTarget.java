...
class P02_09_QuadrupleSumToTarget {
    /**
     * Time complexity
    ...
    public static void main(String[] args) {
        System.out.println(P02_09_QuadrupleSumToTarget.searchQuadruplets(new int[] { 4, 1, 2, -1, 1, -3 }, 1));
        System.out.println(P02_09_QuadrupleSumToTarget.searchQuadruplets(new int[] { 2, 0, -1, 1, -2, 2 }, 2));
    }
}
...
class P03_07_CycleInACircularArray {
    /**
     * Time Complexity
     * The above algorithm will have a time complexity of O(N^2) where ‘N’ is the number of elements in the array.
     * This complexity is due to the fact that we are iterating all elements of the array and trying to find a cycle for
     * each element.
     *
     * Space Complexity
    ...
    public static void main(String[] args) {
        System.out.println(P03_07_CycleInACircularArray.loopExists(new int[] { 1, 2, -1, 2, 2 }));
        System.out.println(P03_07_CycleInACircularArray.loopExists(new int[] { 2, 2, -1, 2 }));
        System.out.println(P03_07_CycleInACircularArray.loopExists(new int[] { 2, 1, -1, -2 }));
    }
}
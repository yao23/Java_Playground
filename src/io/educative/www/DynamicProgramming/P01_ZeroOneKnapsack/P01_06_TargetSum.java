...
public class P01_06_TargetSum {
    ...
    public int findTargetSubsetsV1(int[] num, int s) {
        int totalSum = 0;
        for (int n : num)
            totalSum += n;
        ...
        return countSubsetsV1(num, (s + totalSum) / 2);
    }

    // this function is exactly similar to what we have in 'Count of Subset Sum' problem.
    private int countSubsetsV1(int[] num, int sum) {
        int n = num.length;
    ...
    public static void main(String[] args) {
        P01_06_TargetSum ts = new P01_06_TargetSum();
        int[] num = {1, 1, 2, 3};

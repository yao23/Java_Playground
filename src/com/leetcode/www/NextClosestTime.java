...
public class NextClosestTime { // 681
     ...
     * the one with the smallest cand_elapsed = (time - start) % (24 * 60), as this represents the time that has elapsed
     * since start, and where the modulo operation is taken to be always non-negative.
     *

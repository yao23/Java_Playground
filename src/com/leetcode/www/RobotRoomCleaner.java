...
public class RobotRoomCleaner { // 489 [Google]
     ...
     * Spiral Backtracking
     *
     * Time complexity : O(4^{N - M}), where N is a number of cells in the room and M is a number of obstacles,
 ...
 * In other words, you must control the robot using only the mentioned 4 APIs, without knowing the room layout and the
